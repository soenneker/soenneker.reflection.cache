...
public static class ReflectionCacheRegistrar
{
    ...
    /// </summary>
    public static void AddReflectionCacheAsSingleton(this IServiceCollection services)
    {
    ...
    /// </summary>
    public static void AddReflectionCacheAsScoped(this IServiceCollection services)
    {
